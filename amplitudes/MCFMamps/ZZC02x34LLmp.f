      subroutine ZZC02x34LLmp(j1,j2,j3,j4,j5,j6,za,zb,sprod,mass,
     & Xmp,Xpm)
...
c     & -0.5d0*zb(k2,k4)*zab2(k2,k3,k4,k6)*zab2(k3,k2,k4,k6))
     ...
     &  +zab2(k1,k5,k6,k1)*zb(k2,k4)*sprod(k3,k4)*za(k2,k5)*zb(k2,k6)
     ...
     &  +(s134+sprod(k3,k4))*za(k1,k5)*zb(k2,k4)*zb(k2,k6)
