      subroutine WWtriangle7new(k1,k2,k3,k4,k5,k6,za,zb,sprod,mass,
     &     app,apm)
...
c--- Triangle 7
     ...
     &        -za(k1,k2)*zb(k2,k1)/za34b(k1,k1)*masssq
     &        +za34b(k2,k2))
      t2prod=-za(k1,k2)*zb(k2,k1)/za34b(k1,k1)*masssq
     & *(za34b(k2,k2)
     &  -za(k3,k4)*zb(k4,k3)/za34b(k1,k1)*za(k1,k2)*zb(k2,k1))
      t1234sum=-(za(k1,k2)*zb(k2,k1)/za34b(k1,k1)*za(k3,k4)*zb(k4,k3)
     &          +za(k1,k2)*zb(k2,k1)/za34b(k1,k1)*masssq
     &          +za(k1,k2)*zb(k2,k1))
c      t1234prod=-za(k1,k2)*zb(k2,k1)/za34b(k1,k1)*masssq
c     & *(za34b(k2,k2)
c     &  -za(k3,k4)*zb(k4,k3)/za34b(k1,k1)*za(k1,k2)*zb(k2,k1))
      triamp =  + masssq * (  - za(k1,k3)**2*za(k1,k5)*zb(k1,k2)*
     &     zb(k2,k6
     ...
     &    ) )
      triamp = triamp + masssq * ( za(k1,k5)*za(k3,k4)*zb(k1,k4)**2*
     &     zb(k1
     ...
     &    ) )
      triamp = triamp + masssq * (  - za(k3,k4)*zb(k1,k4)**2*iza(k1,k2)*
     ...
     &    k1,k6)
      ...
      triamp =  + masssq * (  - za(k1,k3)**2*za(k1,k5)*zb(k1,k6)*
     &     zb(k3,k4
     ...
     &    *iza34b(k1,k2)**2*t2sum )
      triamp = triamp + masssq * (  - za(k1,k3)*za(k1,k5)*za(k2,k3)*
     &     zb(k1
     ...
     &    k2)**2*t1234sum )
      triamp = triamp + masssq * ( 2.D0*za(k1,k3)*za(k1,k5)*zb(k1,k4)*
     &    iza(k1,k2)**2*izb(k1,k2)*za34b(k1,k6)*za34b(k2,k1)*iza34b(k1,
