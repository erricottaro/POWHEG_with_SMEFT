      subroutine WWtriangle11new(k1,k2,k3,k4,k5,k6,za,zb,sprod,mass,
     &     app,apm)
...
c--- Triangle 11
     ...
     &        +za(k6,k3)*zb(k3,k6)+za(k6,k4)*zb(k4,k6))/2d0
      ...
      x=(s34*(s56+ga)-masssq*(ga+s34))/(s56*s34-ga**2)
      y=(-s56*(s34+ga)+masssq*(s56+ga))/(s56*s34-ga**2)
      yp1=y+cone
      xm1=x-cone
      ymr=y-s56/ga
      xpr=x+s34/ga
     ...
     &    **2 - za(k3,k56h)*za(k5,k56h)*zb(k4,k34h)*zb(k6,k34h)*iza(k1,
     &    k2)**2*iza(k1,k56h)**2*izb(k1,k34h)**2 )
      triamp = triamp + masssq * ( za(k1,k5)*za(k2,k34h)*za(k3,k34h)*zb(
     ...
     &    iza(k1,k56h)*izb(k1,k34h)*xpr )
      triamp = triamp + masssq * (  - za(k1,k5)*za(k3,k34h)*zb(k1,k2)
     &     *zb(
     ...
     &    k1,k34h) )
      triamp = triamp + masssq * ( za(k2,k5)*za(k3,k56h)*zb(k1,k2)
     &     *zb(k4,
     ...
     &    xm1 )
      triamp = triamp + masssq*t234sum * (  - za(k2,k5)*za(k3,k34h)*
     &     zb(k1
     ...
     &    iza(k1,k2)*iza(k1,k56h)**2*izb(k1,k34h) )
      triamp = triamp + masssq*t134sum * ( za(k1,k5)*za(k2,k34h)*za(k3,
     ...
     &    **2*iza(k1,k56h)*izb(k1,k34h) )
      triamp = triamp + y*masssq * ( za(k1,k5)*za(k2,k34h)*za(k3,k34h)*
     ...
     &    **2*iza(k1,k56h)*izb(k1,k34h) )
      triamp = triamp + x*masssq * ( za(k1,k5)*za(k2,k34h)*za(k3,k56h)*
     ...
     &    k4,k34h)*zb(k6,k34h)*iza(k1,k56h)**4*izb(k1,k34h)**2 )
      triamp = triamp + masssq*s12**(-1) * (  - za(k2,k5)*za(k2,k34h)
     &     *za(
     ...
     &    k34h)*zb(k6,k34h)*iza(k1,k56h)**3*izb(k1,k34h) )
      triamp = triamp + y*masssq*s12**(-1) * (  - za(k2,k5)*za(k2,k34h)*
     ...
     &    k34h)*zb(k6,k56h)*iza(k1,k56h)**3*izb(k1,k34h) )
      triamp = triamp + x*masssq*s12**(-1) * (  - za(k2,k5)*za(k2,k34h)*
