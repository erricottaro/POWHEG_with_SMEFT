      subroutine ZZC01x34LLmp(j1,j2,j3,j4,j5,j6,za,zb,sprod,mass,
     & Xmp,Xpm)
...
c     & -0.5d0*(s234+sprod(k3,k4))*za(k2,k3)**2*zb(k2,k6)**2/za(k3,k4)
c     & -s234*za(k2,k3)*zb(k2,k4)*zb(k2,k6)*zab2(k2,k3,k4,k6)
c     &  /zab2(k2,k3,k4,k2)
c     & +za(k1,k3)*zb(k2,k4)/za(k1,k2)*zab2(k2,k3,k4,k6)**2
c     & -0.5d0*sprod(k3,k4)*za(k2,k3)*zb(k2,k6)/za(k3,k4)*zab2(k3,k2,k4,k6)
...
c     & -0.5d0*zb(k2,k4)*zab2(k2,k3,k4,k6)*zab2(k3,k2,k4,k6))
      ...
      amp2=1d0/sprod(k1,k2)/sprod(k3,k4)/sprod(k5,k6)*(
     ...
     &  +zab2(k2,k5,k6,k2)*za(k1,k3)*sprod(k3,k4)*zb(k1,k6)*za(k1,k5)
     ...
     &  +(s234+sprod(k3,k4))*zb(k2,k6)*za(k1,k3)*za(k1,k5)
...
c      if (docheck) call ggZZcapture('1x34',h3,h5,j1,j2,j3,j4,j5,j6,
c     &                              czero,amp2,czero)
